...
try {
  ...
  dotenv.config(); // Attempt to load .env
  console.log("LOG: dotenv.config() called. Check .env file if API key is missing later.");
} catch (e) {
  console.error("FATAL ERROR: Could not load or parse .env file. Ensure 'dotenv' is installed and '.env' is not malformed.", e);
...
if (require.main === module) {
  ...
  if (!FIRECRAWL_API_KEY) {
    console.error("ERROR: FIRECRAWL_API_KEY is not set in the .env file or environment variables, or it's empty.");
    console.error("Please ensure your .env file contains FIRECRAWL_API_KEY='your_api_key_here' and it's not empty.");
